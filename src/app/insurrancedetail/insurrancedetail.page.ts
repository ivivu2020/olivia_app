...
export class InsurrancedetailPage implements OnInit {
  ...
  next()
  {
    ...
    var formObj = {
      ...
      originDepart1: origin1Str ,
      originDepart2: origin2Str ,
      realDepart1: real1Str,
        ...
        if(isValid){
          ...
          //Kiểm tra nhập ảnh
            if(!se.imageResponse || se.imageResponse.length ==0){
              se.showToastr('Xin vui lòng chọn vé máy bay.');
              valid = false;
              return;
            }
            else if(!se.imageResponseCMND || se.imageResponseCMND.length ==0){
              se.showToastr('Xin vui lòng chọn chứng minh nhân dân.');
              valid = false;
              return;
            }
          //Kiểm tra chọn ảnh của trẻ em
            if(se.childlist.length >0 && se.countchild >0){
              //Trẻ 1
              if(se.child1Name && se.child1ImageResponse.length == 0 ){
                se.showToastr('Xin vui lòng chọn vé máy bay cho trẻ 1.');
                valid = false;
                return;
              }
              else if(se.child1Name && se.child1ImageResponseGKS.length == 0 ){
                se.showToastr('Xin vui lòng chọn giấy khai sinh cho trẻ 1.');
                valid = false;
                return;
              }
              //Trẻ 2
              else if(se.child2Name && se.child2ImageResponse.length == 0 ){
                se.showToastr('Xin vui lòng chọn vé máy bay cho trẻ 2.');
                valid = false;
                return;
              }
              else if(se.child2Name && se.child2ImageResponseGKS.length == 0 ){
                se.showToastr('Xin vui lòng chọn giấy khai sinh cho trẻ 2.');
                valid = false;
                return;
              }
              //Trẻ 3
                ...
                se.showToastr('Xin vui lòng chọn giấy khai sinh cho trẻ 3.');
                valid = false;
                return;
              }
              //Trẻ 4
              else if(se.child4Name && se.child4ImageResponse.length == 0 ){
                se.showToastr('Xin vui lòng chọn vé máy bay cho trẻ 4.');
                valid = false;
                return;
              }
              else if(se.child4Name && se.child4ImageResponseGKS.length == 0 ){
                se.showToastr('Xin vui lòng chọn giấy khai sinh cho trẻ 4.');
                valid = false;
                return;
              }
              //Trẻ 5
              else if(se.child5Name && se.child5ImageResponse.length == 0 ){
                se.showToastr('Xin vui lòng chọn vé máy bay cho trẻ 5.');
                valid = false;
                return;
              }
              else if(se.child5Name && se.child5ImageResponseGKS.length == 0 ){
                se.showToastr('Xin vui lòng chọn giấy khai sinh cho trẻ 5.');
                valid = false;
                return;
              }
            }
