...
export class ExchangeGiftPage implements OnInit{
    ...
    constructor(public platform:Platform,public navCtrl: NavController, public toastCtrl: ToastController,
        public zone: NgZone,public storage: Storage,public alertCtrl: AlertController,private renderer:Renderer,
    ...
    async presentToast(msg) {
      ...
      radioCheck(val){
          this.zone.run(()=>{
            ...
            // var itemListLocation = document.getElementsByClassName('list-location');
            // var itemRadioLocation = document.getElementsByClassName('rd-location');
          ...
          if(this.record){
            ...
            se.storage.get('auth_token').then(auth_token => {
                ...
                request(options, function (error, response, body) {
                  ...
                  if(response.statusCode == 200){
                    // this.presentToast('Đổi quà thành công!');
                    // this.view.dismiss();
