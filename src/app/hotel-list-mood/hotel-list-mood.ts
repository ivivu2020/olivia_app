...
export class HotelListMoodPage implements OnInit{
  ...
  private getdata() {
    ...
    var options = {
      method: 'POST',
      url: C.urls.baseUrl.urlMobile + '/mobile/OliviaApis/HotelByMoodId'+ '?pageIndex=' + this.page + '&pageSize=10'+ (this.memberid ? '&memberid='+this.memberid : ''),
      ...
      for (let index = 0; index < se.dataList.length; index++) {
        ...
        if (se.dataList[index].DealType) {
          ...
          if (se.dataList[index].subLocation[0]) {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, dealPrice: se.dataList[index].dealPrice ? se.dataList[index].dealPrice.toLocaleString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.") :se.dataList[index].dealPrice , dealType: se.dataList[index].dealType, SubLocation: se.dataList[index].subLocation[0].name, Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice : 0 };
          } else {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, dealPrice: se.dataList[index].dealPrice ? se.dataList[index].dealPrice.toLocaleString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1."):se.dataList[index].dealPrice, dealType: se.dataList[index].dealType, SubLocation: '', Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice :0 };
          }
        }
        else {
          if (se.dataList[index].subLocation[0]) {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, dealPrice: se.dataList[index].dealPrice ?se.dataList[index].dealPrice.toLocaleString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1."):se.dataList[index].dealPrice, dealType: se.dataList[index].dealType, SubLocation: se.dataList[index].subLocation[0].name, Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, RoomNameSubString: "", MinPriceOTAStr: se.dataList[index].MinPriceOTAStr, PromotionDescriptionSubstring: "" , Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice : 0};
          } else {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, dealPrice: se.dataList[index].dealPrice ?se.dataList[index].dealPrice.toLocaleString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1."):se.dataList[index].dealPrice, dealType: se.dataList[index].dealType, SubLocation: '', Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, RoomNameSubString: "", MinPriceOTAStr: se.dataList[index].MinPriceOTAStr, PromotionDescriptionSubstring: "" , Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice : 0};
          }
        }
        se.json1.push(item);
      }
